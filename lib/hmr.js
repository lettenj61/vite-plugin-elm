//! This code is mostly copied from https://github.com/klazuka/elm-hot/blob/master/resources/hmr.js
//! then edited to work properly on vite's HMR API.

exports.hmrCode = `//////////////////// HMR BEGIN ////////////////////
...
/*
    ...
    assumed globals:
        ...
        - *CHANGED FOR VITE* the \`module\` identifier is replaced with \`import.meta\`.
...
if (import.meta.hot) {
  (function () {
    ...
    var instances = import.meta.hot.data ? import.meta.hot.data.instances || {} : {};
